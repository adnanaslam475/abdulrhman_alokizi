...
{props.modalName === "Create void and return reason" && (
        <Modal
          scrollable
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title>Create Void and Return Reason </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Row>
              <Col md={12} lg={12}>
            ...
            <Row>
              ...
              <Col md={12} lg={12}>
                <Form.Group className={`${cx.formField}`}>
                  ...
                  <Form.Control type="text" placeholder="hayat mall"/>
                </Form.Group>
              </Col>
