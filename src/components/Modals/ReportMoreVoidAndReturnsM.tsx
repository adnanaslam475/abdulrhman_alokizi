...
const Modals = (props: any) => {
  ...
  return (
    <>
      ...
      {
        props.modalName === 'void return filter' &&
          ...
          <Modal.Body>
              ...
              <Col md={12} lg={12}>
                <Form.Group className={`${cx.formField}`}>
                  {inventoryItems ?
                    <Form.Label className="d-block">
                      Products
                      <NavLink className={`${cx.rightLabel}`} to="#" onClick={() => { setinventoryItems(false) }}>Select by Products</NavLink>
                    </Form.Label> :
                    <Form.Label className="d-block">
                      Products
                      <NavLink className={`${cx.rightLabel}`} to="#" onClick={() => { setinventoryItems(true) }}>Select by tags</NavLink>
            ...
            <Col md={12} lg={12}>
                <Form.Group className={`${cx.formField}`}>
                  ...
                  <Form.Select>
                    <option value="1">Customer Cancelled </option>
                    <option value="2">product Not Available </option>
                  </Form.Select>
                </Form.Group>
              </Col>
