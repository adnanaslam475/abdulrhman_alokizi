...
import { addModifier, deletModifier, editModifierData } from "../../redux_toolkit/reducer/menuModifiersApiReducer";
      ...
      {/* START Edit Modifier */}
      {
        ...
        <Modal scrollable className={`${cx.ctsModal}`} show={props.show} onHide={props.handleClose}>
            ...
            <Row>
              <Col md={12} lg={12}>
                <Form.Group className={`${cx.formField}`}>
                  ...
                  <Form.Control type="text" defaultValue={editModifierData.name} onChange={(e:any)=>{
                    editModifierData.name = e.target.value
                  }}/>
                </Form.Group>
              </Col>
              <Col md={12} lg={12}>
                <Form.Group className={`${cx.formField}`}>
                  ...
                  <Form.Control type="text" defaultValue={editModifierData.name_localized} onChange={(e:any)=>{
                    editModifierData.name_localized = e.target.value
                  }}/>
                </Form.Group>
              </Col>
              <Col md={12} lg={12}>
                <Form.Group className={`${cx.formField}`}>
                  ...
                  <Form.Control type="text" defaultValue={editModifierData.reference} onChange={(e:any)=>{
                    editModifierData.reference = e.target.value
                  }}/>
                </Form.Group>
              </Col>
          ...
          <div><NavLink to="#" className={`${cx.rightOption} ${cx.rightRed}`} onClick={()=>{
            dispatch(deletModifier(editModifierData.id))
          }}>Delete Modifier</NavLink></div>
            <div>
              <Button className={`${cx.btnClose}`} onClick={() => { props.handleClose(); setOrderType('') }}>
                Close
              </Button>
              <Button className={`${cx.btnSubmit}`} onClick={()=>{
                dispatch(addModifier(editModifierData))
              }}>
                Apply
              </Button>
            </div>
