...
import cx from "./Inventorycategories.module.scss";
...
import Modals from "../../components/Modals/InventoryCategoriesM";
          ...
          <div className={`${st.pageTitleRow}`}>
            ...
            <div className={`${st.rowTitleRight}`}>
              ...
              <button className={`btn ${st.themeBtn}`}
                onClick={() => {
                  handleShow("create category", true);
                }}
              >
                Create Category 
              </button>
