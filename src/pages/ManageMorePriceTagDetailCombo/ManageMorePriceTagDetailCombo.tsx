...
import cx from "./ManageMorePriceTagDetailCombo.module.scss";
...
import { priceTagViewDetails, singleComboPriceFunc } from "../../redux_toolkit/reducer/manageMorePriceTagsApiReducer";
...
function EnhancedTable() {
  ...
  useEffect(()=>{
    setRows(priceTagViewDetails?.data?.combo)
                    ...
                    <TableRow
                      ...
                      onClick={() => {
                        let data = {
                          ...
                          price: row?.price,
                          combo_id: row?.pricetag_id,
                          pricetag_id:row?.pricetag_id
                        }
                        dispatch(singleComboPriceFunc(data))
                        handleShow("edit combo details sec", true);
                      }}
                    >
...
export default  function ManageMorePriceTagDetailCombo () {
