...
import cx from "./Menugiftcards.module.scss";
...
import { giftList, giftListItems } from "../../redux_toolkit/reducer/menuGiftCardReducer";
          ...
          <ul className={`${table.rightActionIcons}`}>
            <li>
              <button
                ...
                onClick={() => {
                  handleShow("gift cards filter", true);
                  console.log("check");
                }}
              >
...
function EnhancedTable() {
  ...
  const giftListCount = useSelector((state:any)=>state.menuGiftCardReducer.giftListCount)
  ...
  useEffect(()=>{
    ...
    dispatch(giftList({restaurant_id:data?.restaurant_id}))
  ...
  useEffect(()=>{
    ...
    const rowsData = giftListItems?.map((item: any) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell onClick={() => { redirectToAnotherPage(row?.id) }} align="left">
                        <>
                        <img className={`${st.prImage}`} src={row?.image ? row?.image : prImg} />
                        </>
                      </TableCell>
                      <TableCell
                        component="th"
                      ...
                      <TableCell onClick={() => { redirectToAnotherPage(row?.id) }} align="left">
                        <>
                        {row?.status !== 0 ? <div className={`${st.statusBtn}`} style={{ backgroundColor:'#EB5757', height:"15px", width:"15px", borderRadius:"50%" }}></div> : <div className={`${st.statusBtn}`} style={{ backgroundColor:'#37c4c9', height:"15px", width:"15px", borderRadius:"50%" }}></div>}  
                        </>    
                      </TableCell>
                    </TableRow>
                  );
...
export default function Menugiftcards() {
          ...
          <div className={`${st.pageTitleRow}`}>
            ...
            <div className={`${st.rowTitleRight}`}>
              ...
              <button className={`btn ${st.themeBtn}`}
                onClick={() => {
                  handleShow("create gift cards", true);
                }}
              >
                Create Gift Cards
              </button>
