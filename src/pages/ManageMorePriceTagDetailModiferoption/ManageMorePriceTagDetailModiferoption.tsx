...
import cx from "./ManageMorePriceTagDetailModiferoption.module.scss";
...
import { priceTagViewDetails, singleModifierOptionPriceFunc } from "../../redux_toolkit/reducer/manageMorePriceTagsApiReducer";
        ...
        <div className={`${table.mainTitleRow} ${cx.topTable}`}>
          <ul className={`${table.rightActionIcons}`}>
            ...
            <button
                ...
                onClick={() => {
                  handleShow("modifer option  tag filter", true);
                  console.log("check");
                }}
              >
...
function EnhancedTable() {
  ...
  useEffect(()=>{
    setRows(priceTagViewDetails?.data?.pricetag_modifier)
                    ...
                    <TableRow
                      ...
                      onClick={() => {
                        ...
                        let data = {
                          ...
                          price: row?.price,
                          modifier_id: row?.modifire_id,
                          pricetag_id:row?.pricetag_id
                        }
                        dispatch(singleModifierOptionPriceFunc(data))
                        handleShow("edit modifier details sec", true);
                      }}
                    >
...
export default  function ManageMorePriceTagDetailModiferoption () {
    ...
    <>
      ...
      <div className={`${cx.pageTitle}`}>
                 ...
                 <button
                    className={`btn`}
                    onClick={() => {
                      handleShow("edit modifier prices", true);
                    }}
                  >
                    Edit prices
                  </button>
