...
import cx from "./Menucombos.module.scss";
...
import { comboFilterValue, comboList, comboListItems, comboView } from "../../redux_toolkit/reducer/menuComboApiReducer";
...
function EnhancedTable() {
  ...
  useEffect(() => {
    ...
    const rowsData = comboListItems?.map((item: any) => {
      console.log(item,"comboItem")
      return {
        id: item?.id,
